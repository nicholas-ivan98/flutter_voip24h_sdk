...
class CallModule {
  ...
  static const MethodChannel _methodChannel = MethodChannel('flutter_voip24h_sdk_method_channel');

  static const EventChannel _eventChannel = EventChannel('flutter_voip24h_sdk_event_channel');
