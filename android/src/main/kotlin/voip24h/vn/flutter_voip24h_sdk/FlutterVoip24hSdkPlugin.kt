package voip24h.vn.flutter_voip24h_sdk
...
import voip24h.vn.flutter_voip24h_sdk.sip_manager.SipManager

/** FlutterVoip24hSdkPlugin */
class FlutterVoip24hSdkPlugin : FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        methodChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_voip24h_sdk_method_channel")
        methodChannel.setMethodCallHandler(this)

        eventChannel = EventChannel(flutterPluginBinding.binaryMessenger, "flutter_voip24h_sdk_event_channel")
